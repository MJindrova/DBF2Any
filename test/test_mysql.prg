...
LOCAL m.lcPath, m.loDBF2MYSQL, m.lcAlias, m.lii
...
DO (m.lcPath+"..\src\dbf2any") WITH "create", "mysql", m.loDBF2MYSQL
IF ISNULL(m.loDBF2MYSQL)
   RETURN
ENDIF

m.loDBF2MYSQL.cServer="localhost"
m.loDBF2MYSQL.iPort=3306
m.loDBF2MYSQL.cDB    ="test"
m.loDBF2MYSQL.cUser  ="test"
m.loDBF2MYSQL.cPWD   ="test"

m.loDBF2MYSQL.lReFill=.T.                             && If table in destination exists, delete data
m.loDBF2MYSQL.AttachDataSession(1)                    && Attach default data session
?m.loDBF2MYSQL.UploadDBF("", m.lcAlias, "")           && Upload cursor
?m.loDBF2MYSQL.UploadDBF(m.lcPath+"test.dbf", "", "") && Upload table




DO (m.lcPath+"..\src\dbf2any") WITH "release", "mysql"
